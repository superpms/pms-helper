...
class Snowflake{
    ...
    private static int $maxWorkerId = 1023; //最大的机器节点, 2^10 - 1

    private static int $sequence = 0;
    private static int $sequenceMask = 4095; //最大的序列节点, 2^12 - 1

    private static int $workerIdShift = 12; //机器ID左移位数,63 - 51
    private static int $timestampLeftShift = 22; //毫秒时间戳左移位数,63 - 41

    private static int $twepoch = 1288834974657;
